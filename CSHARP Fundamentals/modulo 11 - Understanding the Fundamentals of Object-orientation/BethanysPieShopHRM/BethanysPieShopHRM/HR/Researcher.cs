    ...
    internal class Researcher : Employee
    {
        ...
        public void ResearchNewPieTastes(int researchHours)
        {
            ...
            if (new Random().Next(100) > 50)
            {
                ...
                Console.WriteLine($"{FirstName} {LastName} has invented a new pie taste! Total invented: {NumberOfPieTastesInvented}");
            }
            else
            {
                Console.WriteLine($"Reseacher  {FirstName} {LastName} is working still on a new pie taste!.");
            }
        }
    }
}
