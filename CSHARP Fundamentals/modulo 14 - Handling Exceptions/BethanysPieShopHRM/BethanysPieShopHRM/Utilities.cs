...
namespace BethanysPieShopHRM
{
    internal class Utilities
    {
        ...
        internal static void LoadEmployees(List<Employee> employees)
        {
            ...
            if(File.Exists(path)){
                ...
                for(int i = 0; i < employeesAsString.Length; i++){
                    string[] employeeSplit = employeesAsString[i].Split(';');
                ...
                Console.WriteLine("There was an error while loading the employee data. Please ensure the data file is not corrupted.");
                Console.WriteLine(iex.StackTrace);
            }
            catch (FileNotFoundException fnfex)
            {
                Console.ForegroundColor = ConsoleColor.Red;
                Console.WriteLine("The employee data file was not found. Please ensure the file exists before loading.");
            ...
            {
                Console.ForegroundColor = ConsoleColor.Red;
                Console.WriteLine("An unexpected error occurred while loading employee data.");
        ...
        internal static void LoadEmployeesById(List<Employee> employees)
        {
            try { 
            ...
            {
                Console.ForegroundColor = ConsoleColor.Red;
                Console.WriteLine("Input format is not valid. Please enter a valid Employee ID.");
                Console.ResetColor();
            }
        }
